  ...
  return (
    ...
    >
      <header className="flex flex-row-reverse justify-between sm:flex-row">
        ...
        >
          {loginScreenState === "LOGIN" ? "S'inscrire" : "Connexion"}
        </button>
      </header>
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
          <h2 className="text-center text-2xl font-bold text-gray-800">
            {loginScreenState === "LOGIN" ? "Connexion" : "Créer votre profil"}
          </h2>
                ...
                <div className="relative flex grow">
                  ...
                  <div className="absolute bottom-0 right-0 top-0 flex items-center justify-center pr-4">
                    <div
                      ...
                      role="button"
                      tabIndex={0}
                      aria-label="Pourquoi avez-vous besoin de mon âge ?"
                    >
                      ?
                      {ageTooltipShown && (
                        <div className="absolute -right-5 top-full z-10 w-72 rounded-2xl border-2 border-gray-200 bg-white p-4 text-center text-xs leading-5 text-gray-800">
                          Fournir votre âge garantit que vous obtenez la bonne expérience IKIGAI.
            ...
            <input
              ...
              placeholder={
                loginScreenState === "LOGIN"
                  ? "Email ou nom d'utilisateur (optionnel)"
                  : "Email (optionnel)"
              }
            />
            <div className="relative flex grow">
          ...
          >
            {loginScreenState === "LOGIN" ? "Connexion" : "Créer un compte"}
          </button>
          ...
          <p className="text-center text-xs leading-5 text-gray-400">
            En vous connectant à IKIGAI, vous acceptez nos{" "}
            <Link
              className="font-bold"
              href="/terms"
            >
          ...
          <p className="text-center text-xs leading-5 text-gray-400">
            Ce site est protégé par reCAPTCHA Enterprise et la{" "}
            <Link
              className="font-bold"
          ...
          <p className="block text-center sm:hidden">
            ...
            >
              {loginScreenState === "LOGIN" ? "s'inscrire" : "se connecter"}
            </button>
          </p>
        </div>
      </div>
