      ...
      <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
        <article className="my-6 flex justify-between gap-4">
          ...
          >
            ...
            >
              <h2 className="text-center text-lg font-bold">Série</h2>
              <p className="text-center text-sm font-normal text-gray-400">
                {`Attention, votre série sera remise à zéro demain si vous ne pratiquez pas demain !`}
              </p>
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      <h2 className="text-xl font-bold">Débloquez les classements !</h2>
      <div className="flex items-center gap-6">
        <LockedLeaderboardsSvg />
        <p className="text-sm leading-6 text-gray-500">
          Complétez {lessonsNeededToUnlockLeaderboards} leçon
          {lessonsNeededToUnlockLeaderboards === 1 ? "" : "s"} de plus pour 
...
const LeaderboardRankSection = () => {
  ...
  const leaderboardLeague = "Ligue Bronze";
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
        ...
        <div className="flex flex-col gap-5">
          {rank !== null && (
            <p className="text-lg font-bold text-gray-700">
              {`Vous êtes classé #${rank}`}
            </p>
          )}
          <p className="text-sm leading-6 text-gray-500">
            Vous avez gagné {xpThisWeek} XP cette semaine
          </p>
        </div>
      </div>
    </article>
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <h2 className="text-xl">Quêtes quotidiennes</h2>
      <div className="flex items-center gap-4">
        <LightningProgressSvg />
        <div className="flex flex-col gap-2">
          <h3>Gagner {goalXp} XP</h3>
...
const XpProgressSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <div className="flex items-center justify-between">
        <h2 className="text-xl">Progression XP</h2>
      ...
      <div className="flex gap-5">
        ...
        <div className="flex grow flex-col justify-around">
          <h3 className="font-normal text-gray-500">Objectif quotidien</h3>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
      <h2 className="text-xl">Créez un profil pour sauvegarder votre progression !</h2>
      <button
